...
<div
	className="
		bg-no-repeat bg-cover bg-indigo bg-opacity-25
       bg-[url('/img/back2.jpg')]
		xl:bg-[url('/img/back2.jpg')]

">
	<div class="container mx-auto flex flex-col h-screen w-full md:flex-col my-3 md:my-3">
			<div class="flex flex-col w-full lg:w-full h-3/4 justify-center  p-8">
				<h1 class="mt-12 text-3xl md:text-7xl p-2 text-yellow-600 tracking-loose ">ADVENT FILMS</h1>
				<h2 class="text-xl md:text-xl leading-relaxed md:leading-snug mb-2 text-white">Music & Video Production Studio
				</h2>
        <h2 class="text-xl md:text-base leading-relaxed  mb-2 text-yellow-500"><em>Produce Now Pay Later</em>
				</h2>
				<p class="text-sm md:text-base text-gray-50 mb-4">Get quality audio and video recordings at custom prices. Serving you with exactly what you need.</p>
				<a href="#Get"
					class=" mt-14 bg-yellow hover:bg-amber-200 hover:w-max text-xl text-yellow-600 hover:text-black rounded shadow hover:shadow-lg py-2  ">
					Explore Plans</a>
			</div>
        ...
        <div class="flex flex-col items-center xl:items-center xl:mx-8 xl-flex" id="Get" >
                <h1 class="text-2xl font-medium text-amber-800 capitalize lg:text-3xl dark:text-white">Our Pricing Plan</h1>
                ...
                Pay 40% or the principal amount and you're good to go. 
Balance cleared within 60 to 90 days depending on the plan. 
Terms and conditions apply. 
                ...
                <a href="#readmore" class="flex items-center mt-4 -mx-1 text-sm text-gray-700 capitalize dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
                    <span class="mx-1 text-amber-800">read more</span>
...
<span class="block text-xl text-purple-500 font-bold">Off</span>
                    ...
                    <ul role="list" class="w-full space-y-4 py-6 m-auto text-gray-600">
                        <li class="space-x-2">
    ...
    <svg aria-hidden="true" class="w-5 h-5 text-gray-300 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Fifth star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
      ...
      <section className="relative bg-blue-gray-50/50 py-24 px-4">
        <div className="container mx-auto ">
          <PageTitle heading="Here For You">
            Get 5 to 10% on referrals on every project. 
    <div class="mt-5 flex items-center justify-center">
      <div class="bg-gray-200 w-full h-3/4 mx-4 p-4 rounded-xl md:w-full lg:w-full">
 ...
 <svg
          ...
          <div class="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
            ...
            <input 
             ...
             class="w-full outline-none bg-transparent" type="text" placeholder="link" value="https://vercel.com/ibrah-55/advent/2P99Bb3qiTLxEDrx5jjMG6gdrVT7" />
...
Fill in the form below to join our trainers union. Get a choir and start training . 
                </p>

          </PageTitle>
          <form ref={form} onSubmit={sendEmail} className="mx-auto mt-12 max-w-3xl text-center">
            <div className="mb-8 flex gap-5">
            <Input type="text"  name="from_name" id="from_name" variant="standard" size="lg" label="Your Name" />
